...
class TransactionGroupsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create transaction_group" do
    assert_difference('TransactionGroup.count') do
      post transaction_groups_url, params: { transaction_group: { group_id: @transaction_group.group_id, transaction_id: @transaction_group.transaction_id } }
    end
  ...
  test "should update transaction_group" do
    patch transaction_group_url(@transaction_group), params: { transaction_group: { group_id: @transaction_group.group_id, transaction_id: @transaction_group.transaction_id } }
